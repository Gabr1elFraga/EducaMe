...
public class Aula {
	...
	public Aula(UUID id, Aluno aluno, Professor professor, Disciplina disciplina, OffsetDateTime inicio, OffsetDateTime fim, AulaStatus status, String modalidade, String observacao) {
		this.id = id;
		this.aluno = aluno;
